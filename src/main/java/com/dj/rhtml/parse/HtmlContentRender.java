...
public class HtmlContentRender {
	...
	public String parse(String url,Map<String, String> header) throws IOException{
		...
		//IOUtils.write(html, new FileWriter("/home/houdejun/working/temp/test-org.html"));
		Document doc = Jsoup.parse(html);
		try {
			HtmlScriptExecutor scriptExecutor = new HtmlScriptExecutor();
			//scriptExecutor.loadJS("jquery.js");
			...
			//scriptExecutor.evalScript("console.log(\"The body is:\"+ $(\"body\").html());");
			return documentHtml;
		} finally {
			Context.exit();
		}
